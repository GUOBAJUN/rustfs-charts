...
| ingress.className        | Specify the ingress class, traefik or nginx. | `""`               |



**NOTE**: [local-path](https://github.com/rancher/local-path-provisioner)[local-path](https://github.com/rancher/local-path-provisioner) is used by k3s. If you want to use `local-path`, running the command,
